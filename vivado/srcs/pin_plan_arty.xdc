...
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { uart_tx }]; #IO_0_15 Sch=ja[1]
...
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { ard_finj }]; #IO_L16P_T2_CSI_B_14 Sch=ck_io[0]
